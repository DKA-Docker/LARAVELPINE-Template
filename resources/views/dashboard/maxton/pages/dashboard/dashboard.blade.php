<x-Dashboard.Pages.MainContent :theme="$theme" :account="$account">
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-7">
                            <div class="d-flex align-items-center gap-3 mb-5">
                                ...
                                <div class="">
                                    ...
                                    <h4 class="fw-semibold mb-0 fs-4 mb-0">{{ $account->information->first_name }}</h4>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-sm-5">
                            <div class="welcome-back-img pt-4">
                                <img src="{{ asset('/storage/images/gallery/welcome-back-3.png') }}" height="180" alt="">
                            </div>
                        </div>
                    </div><!--end row-->
                </div>
            ...
            <div class="card w-100 rounded-4">
                <div class="card-body">
                    <div class="d-flex align-items-start justify-content-between mb-3">
                        ...
                        <div class="dropdown">
                            <a href="javascript:void(0);" class="dropdown-toggle-nocaret options dropdown-toggle" data-bs-toggle="dropdown">
                                <span class="material-icons-outlined fs-5">more_vert</span>
                            </a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="javascript:void(0);">Action</a></li>
                    ...
                    <div class="d-flex flex-column justify-content-between gap-4">
                        <div class="d-flex align-items-center gap-4">
                            <div class="d-flex align-items-center gap-3 flex-grow-1">
                                <img src="{{ asset('/storage/images/apps/17.png') }}" width="32" alt="">
                        ...
                        <div class="d-flex align-items-center gap-4">
                            <div class="d-flex align-items-center gap-3 flex-grow-1">
                                <img src="{{ asset('/storage/images/apps/18.png') }}" width="32" alt="">
                        ...
                        <div class="d-flex align-items-center gap-4">
                            <div class="d-flex align-items-center gap-3 flex-grow-1">
                                <img src="{{ asset('/storage/images/apps/19.png') }}" width="32" alt="">
                        ...
                        <div class="d-flex align-items-center gap-4">
                            <div class="d-flex align-items-center gap-3 flex-grow-1">
                                <img src="{{ asset('/storage/images/apps/20.png') }}" width="32" alt="">
                        ...
                        <div class="d-flex align-items-center gap-4">
                            <div class="d-flex align-items-center gap-3 flex-grow-1">
                                <img src="{{ asset('/storage/images/apps/05.png') }}" width="32" alt="">
                        ...
                        <div class="d-flex align-items-center gap-4">
                            <div class="d-flex align-items-center gap-3 flex-grow-1">
                                <img src="{{ asset('/storage/images/apps/08.png') }}" width="32" alt="">
                        ...
                        <div class="d-flex align-items-center gap-4">
                            <div class="d-flex align-items-center gap-3 flex-grow-1">
                                <img src="{{ asset('/storage/images/apps/07.png') }}" width="32" alt="">
            ...
            <div class="card w-100 rounded-4">
                ...
                <div class="card-body p-0">
                    <div class="user-list p-3">
                        <div class="d-flex flex-column gap-3">
                            <div class="d-flex align-items-center gap-3">
                                <img src="{{ asset('/storage/images/avatars/01.png') }}" width="45" height="45" class="rounded-circle" alt="">
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <img src="{{ asset('/storage/images/avatars/02.png') }}" width="45" height="45" class="rounded-circle" alt="">
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <img src="{{ asset('/storage/images/avatars/03.png') }}" width="45" height="45" class="rounded-circle" alt="">
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <img src="{{ asset('/storage/images/avatars/04.png') }}" width="45" height="45" class="rounded-circle" alt="">
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <img src="{{ asset('/storage/images/avatars/05.png') }}" width="45" height="45" class="rounded-circle" alt="">
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <img src="{{ asset('/storage/images/avatars/06.png') }}" width="45" height="45" class="rounded-circle" alt="">
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <img src="{{ asset('/storage/images/avatars/08.png') }}" width="45" height="45" class="rounded-circle" alt="">
                                <div class="flex-grow-1">
                ...
                <div class="card-footer bg-transparent p-3">
                    <div class="d-flex align-items-center justify-content-between gap-3">
                        <a href="javascript:void(0);" class="sharelink"><i class="material-icons-outlined">share</i></a>
                        <a href="javascript:void(0);" class="sharelink"><i class="material-icons-outlined">textsms</i></a>
                        <a href="javascript:void(0);" class="sharelink"><i class="material-icons-outlined">email</i></a>
                        <a href="javascript:void(0);" class="sharelink"><i class="material-icons-outlined">attach_file</i></a>
                        <a href="javascript:void(0);" class="sharelink"><i class="material-icons-outlined">event</i></a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <table class="table align-middle">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="">
                                            <img src="{{ asset('/storage/images/top-products/01.png') }}" class="rounded-circle" width="50" height="50" alt="">
                                        </div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="">
                                            <img src="{{ asset('/storage/images/top-products/02.png') }}" class="rounded-circle" width="50" height="50" alt="">
                                        </div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="">
                                            <img src="{{ asset('/storage/images/top-products/03.png') }}" class="rounded-circle" width="50" height="50" alt="">
                                        </div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="">
                                            <img src="{{ asset('/storage/images/top-products/04.png') }}" class="rounded-circle" width="50" height="50" alt="">
                                        </div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="">
                                            <img src="{{ asset('/storage/images/top-products/06.png') }}" class="rounded-circle" width="50" height="50" alt="">
                                        </div>
