    ...
    <div class="sidebar-nav">
        ...
        <ul class="metismenu" id="sidenav">
            ...
            <li>
                ...
                <ul>
                    <li><a class="has-arrow" href="javascript:void(0);"><i class="material-icons-outlined">arrow_right</i>Basic</a>
                        <ul>
                    ...
                    <li><a class="has-arrow" href="javascript:void(0);"><i class="material-icons-outlined">arrow_right</i>Cover</a>
                        <ul>
                    ...
                    <li><a class="has-arrow" href="javascript:void(0);"><i class="material-icons-outlined">arrow_right</i>Boxed</a>
                        <ul>
            ...
            <li>
                ...
                <ul>
                    <li><a class="has-arrow" href="javascript:void(0);"><i class="material-icons-outlined">arrow_right</i>Level
                            One</a>
                        <ul>
                            <li><a class="has-arrow" href="javascript:void(0);"><i class="material-icons-outlined">arrow_right</i>Level
                                    Two</a>
                                <ul>
                                    <li><a href="javascript:void(0);"><i class="material-icons-outlined">arrow_right</i>Level Three</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
