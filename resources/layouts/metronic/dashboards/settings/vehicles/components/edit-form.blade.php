    ...
    <div class="kt-card bg-white shadow-sm rounded-2xl overflow-hidden">
        <div class="kt-card-body pt-6 pb-6 px-6 sm:px-9">
            <div class="flex flex-wrap sm:flex-nowrap justify-between items-center">
                <div>
                    <h2 class="text-xl font-bold text-gray-900 leading-none mb-2">Edit Vehicle</h2>
                    <p class="text-sm text-gray-500 font-medium">Update vehicle details.</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="p-8">
                    <form wire:submit.prevent="update" class="flex flex-col gap-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            {{-- License Plate --}}
                            <div class="flex flex-col gap-2">
                                <label class="text-[10px] font-black text-gray-400 uppercase tracking-wider ml-1">License Plate</label>
                                <input type="text" wire:model="plate" class="kt-input h-14 rounded-2xl border-gray-100 focus:ring-4 focus:ring-blue-50 font-bold text-gray-700 shadow-sm transition-all pl-4" placeholder="Enter license plate" />
