        ...
        <div class="kt-card-content p-5">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5 text-left">
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <div class="relative group">
                        <input wire:model="formData.credential.password" class="kt-input focus:ring-4 focus:ring-emerald-50 border-gray-100 rounded-xl h-11 pl-10 font-bold text-gray-700 shadow-sm transition-all" type="password" placeholder="Biarkan kosong jika tidak diubah"/>
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <div class="relative group">
                        <input wire:model="formData.credential.password_confirmation" class="kt-input focus:ring-4 focus:ring-emerald-50 border-gray-100 rounded-xl h-11 pl-10 font-bold text-gray-700 shadow-sm transition-all" type="password" placeholder="Konfirmasi password baru"/>
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                            <i class="ki-filled ki-password text-lg text-gray-300 group-focus-within:text-emerald-500 transition-colors"></i>
                        </div>
                    </div>
                    @error('formData.credential.password_confirmation') <span class="text-red-500 text-[10px] font-bold ml-1 italic">{{ $message }}</span> @enderror
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="flex items-center justify-end gap-4 w-full">
            ...
            <button wire:click="submit" wire:loading.attr="disabled" class="group relative overflow-hidden bg-gray-900 px-8 py-3.5 rounded-xl shadow-lg transition-all hover:bg-emerald-600 active:scale-95 disabled:opacity-50">
                <div class="relative z-10 flex items-center gap-3">
                    <span wire:loading.remove wire:target="submit" class="text-[11px] font-black text-white uppercase tracking-[0.2em]">UPDATE ACCOUNT</span>
