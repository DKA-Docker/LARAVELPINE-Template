<x-metronic.dashboards.layouts.container>
    ...
    <div class="flex grow">
        ...
        <!-- Wrapper -->
        <div class="kt-wrapper grow flex flex-col h-screen">
            ...
            <main class="grow overflow-y-auto pb-8" id="content" role="content">
                ...
                <!-- Container -->
                @livewire("metronic.dashboards.apps.deliveries.requests.particles.headings.headings")
                <!-- End of Container -->
                @livewire("metronic.dashboards.apps.deliveries.requests.view")
            </main>
            <!-- End of Content -->
    ...
    @if(session('message'))
        <div id="flash-toast" 
             class="fixed top-5 right-5 z-[9999] flex items-center w-full max-w-xs p-4 space-x-3 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 transform transition-all duration-300 translate-x-full opacity-0" 
             role="alert">
            ...
            <button type="button" onclick="document.getElementById('flash-toast').remove()" class="ml-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700" aria-label="Close">
        ...
        <script>
            // Execute when the DOM is ready (or immediately if inserted via Livewire Nav)
            (() => {
                const showToast = () => {
                ...
                // Also listener for Turbo/Livewire load just in case
