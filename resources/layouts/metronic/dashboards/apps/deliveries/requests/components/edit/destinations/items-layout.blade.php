<div class="kt-card border-none shadow-xl shadow-red-100/50 rounded-2xl ring-1 ring-red-50 request-create-destinations-wrapper">
            ...
            >
                ...
                <div class="{{ ($open[$index] ?? false) ? 'block' : 'hidden' }} p-6 bg-white border-t border-gray-100 animate-fade-in">
                    ...
                    <div class="pt-4 border-t border-gray-50">
                        <livewire:metronic.dashboards.apps.deliveries.requests.components.edit.destinations.packages.items-layout
