        ...
        <div class="kt-wrapper flex grow flex-col h-screen">
            ...
            <main class="grow overflow-y-auto pb-8" id="content" role="content">
                 ...
                 <div class="kt-container-fixed mb-5">
                    @section('breadcrumbs')
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('dashboards.apps.deliveries.requests.index') }}" class="text-muted text-hover-primary">
                                Requests
                            </a>
                        </li>
                        <li class="breadcrumb-item text-muted">
                ...
                <div class="kt-container-fixed">
                     @livewire('metronic.dashboards.apps.deliveries.requests.components.view.view', ['requestId' => $requestId])
                </div>
            </main>
            <!-- End of Content -->
