    ...
    <div class="flex grow">
        ...
        <div class="kt-wrapper flex grow flex-col h-screen">
            ...
            <main class="grow overflow-y-auto pb-8" id="content" role="content">
                ...
                <div class="kt-container-fixed">
                    <div class="flex flex-wrap items-center justify-between gap-5 pb-7.5 lg:items-end">
                        <div class="flex flex-col justify-center gap-2">
                            <h1 class="text-mono text-xl leading-none font-medium">Edit Data Task</h1>
                        </div>
                    </div>
                </div>
                <!-- End of Container -->
                <!-- Container -->
                <div class="kt-container-fixed">
                    <div class="dashboards-apps-deliveries-tasks-edit gap-5 lg:gap-7.5 mx-auto">
                        @livewire("metronic.dashboards.apps.deliveries.tasks.components.edit-form", ['taskId' => $taskId])
                    </div>
                </div>
                <!-- End of Container -->
            </main>
