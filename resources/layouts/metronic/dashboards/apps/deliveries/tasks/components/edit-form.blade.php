<div x-init="$dispatch('init-map')">
    <div class="space-y-8 animate-fade-in">
        ...
        <div class="flex items-center justify-end gap-5">
            <a
                href="{{ route('dashboards.apps.deliveries.tasks.index') }}"
                wire:navigate
            ...
            <button wire:click="submit" wire:loading.attr="disabled" class="group relative overflow-hidden bg-gray-900 px-12 py-5 rounded-2xl shadow-2xl transition-all hover:bg-emerald-600 active:scale-95 disabled:opacity-50">
                <div class="relative z-10 flex items-center gap-3">
                    <span wire:loading.remove wire:target="submit" class="text-[11px] font-black text-white uppercase tracking-[0.2em]">Update Task</span>
                    <span wire:loading wire:target="submit" class="text-[11px] font-black text-white uppercase tracking-[0.2em]">Updating...</span>
