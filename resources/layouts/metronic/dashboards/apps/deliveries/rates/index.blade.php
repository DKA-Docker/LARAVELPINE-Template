            ...
            <main class="grow overflow-y-auto pb-8" id="content" role="content">
                ...
                <div class="kt-container-fixed flex flex-col gap-5">
                    <div class="flex flex-col gap-1">
                        <h1 class="text-foreground font-semibold text-2xl">Data Rates</h1>
                        <div class="text-muted-foreground text-sm">Manage your delivery rates here.</div>
                    </div>
                </div>
                <!-- End of Container -->
                @livewire("metronic.dashboards.apps.deliveries.rates.view")
            </main>
            <!-- End of Content -->
