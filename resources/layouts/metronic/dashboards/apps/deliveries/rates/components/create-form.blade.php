<div class="kt-container-fixed">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <div class="px-7 py-5">
                <div class="kt-card border-none bg-red-50 rounded-2xl p-5 flex items-center gap-4 animate-scale-in border border-red-100 shadow-sm">
                    ...
                    <div class="flex flex-col">
                        <span class="text-xs font-black text-red-900 uppercase tracking-widest leading-none mb-1">{{ __('dashboard.rates.create.validation_error.title') }}</span>
                        <p class="text-[11px] text-red-600 font-bold uppercase tracking-tight">{{ __('dashboard.rates.create.validation_error.message') }}</p>
                    </div>
                </div>
            </div>
        @endif
        ...
        <div class="px-7 py-5 border-b border-gray-200">
            ...
            <h3 class="font-bold text-gray-900 text-lg">Rate Details</h3>
        </div>
