...
<div class="kt-menu flex grow flex-col gap-1" data-kt-menu="true" data-kt-menu-accordion-expand-all="false" id="sidebar_menu">
    <div class="kt-menu-item">
        <a href="{{ request()->getSchemeAndHttpHost() . route('dashboards.index', [], false) }}">
            <div class="kt-menu-label border border-transparent gap-[10px] ps-[10px] pe-[10px] py-[6px]" href="{{ request()->getSchemeAndHttpHost() . route('dashboards.index', [], false) }}" tabindex="0">
    ...
    <div class="kt-menu-item">
        <a href="{{ request()->getSchemeAndHttpHost() . route('dashboards.apps.trackings.index', [], false) }}">
            <div class="kt-menu-label border border-transparent gap-[10px] ps-[10px] pe-[10px] py-[6px]" href="{{ request()->getSchemeAndHttpHost() . route('dashboards.apps.trackings.index', [], false) }}" tabindex="0">
                 <span class="kt-menu-icon items-start text-muted-foreground w-[20px]">
