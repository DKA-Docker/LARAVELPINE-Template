        ...
        <div class="kt-menu-accordion before:border-border relative gap-1 ps-[10px] before:absolute before:start-[20px] before:top-0 before:bottom-0 before:border-s">
            <div class="kt-menu-item">
                ...
                >
                    ...
                    <span class="kt-menu-title text-2sm text-foreground kt-menu-item-active:text-primary kt-menu-item-active:font-semibold kt-menu-link-hover:!text-primary font-medium">
                        Request
                    </span>
                </a>
            </div>
