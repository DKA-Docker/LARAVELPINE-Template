                ...
                const $item = $(`
                    <div class="px-4 py-3 hover:bg-blue-50 dark:hover:bg-neutral-800 cursor-pointer transition-colors">
                        <div class="flex flex-col pointer-events-none">
                            <span class="text-[11px] font-bold text-gray-800 dark:text-neutral-100">${feature.place_name}</span>
                            <span class="text-[9px] text-gray-400 line-clamp-1">${feature.text}</span>
                        </div>
                    </div>
                `);
