...
use App\Http\Controllers\V1\Frontend\Dashboards\Apps\Deliveries\Tasks\Create as DeliveriesTaskCreate;
...
Route::middleware(['auth:web'])->prefix('dashboards')->name('dashboards.')->group(function () {
    /** Name Route dashboards.apps */
    Route::resource('/', DashboardsIndex::class);
    ...
    Route::prefix('apps')->name('apps.')->group(function () {
        ...
        Route::prefix('deliveries')->name('deliveries.')->group(function () {
            ...
            Route::prefix('tasks')->name('tasks.')->group(function () {
                ...
                Route::resource('create',DeliveriesTaskCreate::class);
