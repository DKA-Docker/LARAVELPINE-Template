...
class History extends Component
{
    ...
    {
        return view('dashboards.apps.deliveries.tasks.components.view.tabs.history-skeleton');
    }

    public function render()
    {
        return view('dashboards.apps.deliveries.tasks.components.view.tabs.history', [
            'task' => $this->task
        ]);
    }
}
