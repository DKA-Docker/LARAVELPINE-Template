...
namespace App\Livewire\Metronic\Dashboards\Apps\Deliveries\Requests\Components\Edit\Destinations;
...
class ItemsLayout extends Component
{
    ...
    {
        return view('dashboards.apps.deliveries.requests.components.edit.destinations.items-layout');
    }
}
