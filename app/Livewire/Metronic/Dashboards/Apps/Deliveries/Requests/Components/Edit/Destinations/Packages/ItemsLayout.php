...
namespace App\Livewire\Metronic\Dashboards\Apps\Deliveries\Requests\Components\Edit\Destinations\Packages;
...
class ItemsLayout extends Component
{
    ...
    {
        return view('dashboards.apps.deliveries.requests.components.edit.destinations.packages.items-layout');
    }
}
