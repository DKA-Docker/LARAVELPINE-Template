...
namespace App\Services\Resources\Deliveries\Tasks\Routes;

use App\Repositories\Apps\Deliveries\Tasks\Routes\TasksRoutesRepository;
use App\Repositories\Apps\Deliveries\Tasks\TasksRepository;
use Illuminate\Http\Request;
use Illuminate\Support\Collection;

class ResourcesDeliveriesTaksRoutesServices
{

    protected TasksRoutesRepository $repository;

    public function __construct()
    {
        $this->repository = new TasksRoutesRepository();
    }
