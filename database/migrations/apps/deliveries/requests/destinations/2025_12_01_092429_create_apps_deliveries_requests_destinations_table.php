...
return new class extends Migration
{
    ...
    {
        Schema::create('apps_deliveries_requests_destinations', function (Blueprint $table) {
            ...
            /** adalah deliveries request destinations  */
            $table->foreignUuid('request')->comment('adalah id Request dari si destination')->constrained('apps_deliveries_requests' )->onDelete('cascade');
            /** Nama Penerima Item */
    ...
    {
        Schema::dropIfExists('apps_deliveries_requests_destinations');
    }
};
