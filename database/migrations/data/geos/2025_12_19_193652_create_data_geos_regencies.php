...
return new class extends Migration
{
    ...
    {
        Schema::create('data_geos_regencies', function (Blueprint $table) {
            ...
            $table->foreignId('province_id')->comment('Memuat Id parentnya')->constrained('data_geos_provinces' )->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('data_geos_regencies');
    }
};
