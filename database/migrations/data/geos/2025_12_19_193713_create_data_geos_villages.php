...
return new class extends Migration
{
    ...
    {
        Schema::create('data_geos_villages', function (Blueprint $table) {
            ...
            $table->foreignId('district_id')->comment('Memuat Id parentnya')->constrained('data_geos_districts' )->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('data_geos_villages');
    }
};
